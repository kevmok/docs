...
1. Set up an **action**.
2. Build the **Compound Action**, containing three actions and a notify expression.
3. Add the Compound Action to your AI Agent by launching a **Plugin**.
...
5. Enter the details of your API:
   ...
   iii. Click "Import" (your Action should now be auto-populated with details).
...
3. Copy the following expression into the Compound Action Editor and
...
3. In the “Workflow Overview” section click “System” in the Trigger box.
   ...
   ii. Click on the "Body" in the "Workflow Overview

   ![](/images/docs/7a9616790d77d90664cd93489448cd09620d91b63e681a6936f9e34e126f7bca-CleanShot_2025-09-02_at_09.35.41.png)

   1. Configure your system body to connect your compound action to the plugin
