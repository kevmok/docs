...
<Steps>
  ...
  <Step title="Set Title and Description">
    Set the following Title and Description for your listener (be sure to replace **first**and **lastn** with your corresponding information).
  ...
  <Step title="Confirm Security Warning">
...
<Steps>
  <Step title="Open Purple API Tool">
    Go the [Moveworks Purple API Tool](/docs/purple-api-tool)
  </Step>
  ...
  <Step title="Configure Webhook Fields">
  ...
  <Step title="Generate Webhook Payload">
    ...
    Change the `data` and `email` fields to the corresponding values you would want.
  </Step>
